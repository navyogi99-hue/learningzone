...
VALUES (
    ...
    (
        5,
        '9780198520115',
        'Oxford Classical History Atlas',
        3,
        2002,
        'History',
        1,
...
VALUES (
        ...
        'fine_payments',
        1,
        'Late return settlement from User ID 4'
    );
...
VALUES (
        ...
        '2026-03-12 11:15:00',
        'WATER_DAMAGE',
        'Liquid stains across back index pages',
        35.00,
        'CHARGED',
        '2026-03-15 09:00:00'
    );
...
VALUES (
        ...
        35.00,
        'PAID',
        'Water damage compensation penalty'
    );
...
VALUES (
        ...
        'fine_payments',
        3,
        'Late fee collected Card user 5'
    );
...
VALUES (
        ...
        10.00,
        'PARTIALLY_PAID',
        'First week overdue notice calculation'
    );
...
VALUES (
        ...
        'fine_payments',
        4,
        'Partial payment fine installment'
    );
...
VALUES (
        ...
        0.00,
        20.00
    ), -- $35 damage paid, $30 fine ($10 paid, $20 due)
    (
        4,
        0.00,
        50.00,
...
VALUES (
        ...
        'loan_period_days',
        '14',
        'Default borrowing window in days'
    ),
    (
        2,
        'fine_per_day',
        '5.00',
        'Late-return fine charged per overdue day'
    ),
    (
        3,
        'max_books_per_student',
        '3',
        'Maximum simultaneous loans per student'
    ),
    (
        4,
        'reservation_expiry_days',
        '3',
        'Days a READY reservation is held before expiring'
    ),
    (
        5,
        'fine_grace_days',
        '30',
        'Days a student has to pay an assessed fine'
    );
...
VALUES (
        ...
        'EMAIL',
        'Book overdue',
        'Your loan of "Introduction to Algorithms" is overdue. Please return it.',
        'OVERDUE_REMINDER',
        'loan_transactions',
        10,
        'SENT',
    ...
    (
        ...
        'EMAIL',
        'Reserved book ready',
        'The book you reserved is now ready for pickup.',
        'RESERVATION_READY',
        'reservations',
        3,
        'SENT',
