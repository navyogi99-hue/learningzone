...
CREATE TABLE librarians (
    ...
    CONSTRAINT fk_librarians_user FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE book_authors (
    ...
    CONSTRAINT fk_book_authors_author FOREIGN KEY (author_id) REFERENCES authors (author_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE book_copies (
    ...
    CONSTRAINT fk_book_copies_book FOREIGN KEY (book_id) REFERENCES books (book_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE loan_transactions (
    ...
    CONSTRAINT fk_loans_borrower_user FOREIGN KEY (borrower_user_id) REFERENCES users (user_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_loans_issued_by_librarian FOREIGN KEY (issued_by_librarian_id) REFERENCES librarians (librarian_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_loans_returned_by_librarian FOREIGN KEY (returned_by_librarian_id) REFERENCES librarians (librarian_id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE damage_reports (
    ...
    CONSTRAINT fk_damage_loan FOREIGN KEY (loan_id) REFERENCES loan_transactions (loan_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_damage_copy FOREIGN KEY (copy_id) REFERENCES book_copies (copy_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_damage_reported_by_user FOREIGN KEY (reported_by_user_id) REFERENCES users (user_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_damage_reported_by_librarian FOREIGN KEY (reported_by_librarian_id) REFERENCES librarians (librarian_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE fines (
    ...
    CONSTRAINT fk_fines_loan FOREIGN KEY (loan_id) REFERENCES loan_transactions (loan_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_fines_damage FOREIGN KEY (damage_report_id) REFERENCES damage_reports (damage_report_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_fines_user FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE fine_payments (
    ...
    CONSTRAINT fk_fine_payments_fine FOREIGN KEY (fine_id) REFERENCES fines (fine_id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_fine_payments_received_by_librarian FOREIGN KEY (received_by_librarian_id) REFERENCES librarians (librarian_id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE book_ledger_entries (
    ...
    CONSTRAINT fk_book_ledger_book FOREIGN KEY (book_id) REFERENCES books (book_id) ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT fk_book_ledger_copy FOREIGN KEY (copy_id) REFERENCES book_copies (copy_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_book_ledger_loan FOREIGN KEY (loan_id) REFERENCES loan_transactions (loan_id) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT fk_book_ledger_damage FOREIGN KEY (damage_report_id) REFERENCES damage_reports (damage_report_id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE user_accounts (
    ...
    PRIMARY KEY (user_id),
    CONSTRAINT fk_user_accounts_user FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE reservations (
    ...
    CONSTRAINT fk_reservations_loan FOREIGN KEY (fulfilled_loan_id) REFERENCES loan_transactions (loan_id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE journals (
    ...
    CONSTRAINT fk_journals_publisher FOREIGN KEY (publisher_id) REFERENCES publishers (publisher_id) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB;
...
CREATE TABLE journal_subscriptions (
    ...
    CONSTRAINT fk_subscriptions_journal FOREIGN KEY (journal_id) REFERENCES journals (journal_id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB;
...
SELECT
    ...
    SUM(
        CASE
            WHEN l.status IN ('DAMAGED', 'LOST') THEN 1
            ELSE 0
        END
    ) AS problem_loans
FROM
...
GROUP BY
    DATE_FORMAT(ble.entry_date, '%Y-%m'),
    ble.entry_type;